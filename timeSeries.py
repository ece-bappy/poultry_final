...
sns.scatterplot(x='Temperature', y='Humidity', hue='Day_Number', palette='tab10', data=data, legend=False)
sns.regplot(x='Temperature', y='Humidity', data=data, scatter=False, color='blue')
plt.title('Temperature vs. Humidity')
plt.xlabel('Temperature')
plt.ylabel('Humidity')
plt.tight_layout()
plt.savefig('Temperature_vs_Humidity.png', dpi=300)
plt.show()

# Scatter plot for Temperature vs. Gas Level with regression line
plt.figure(figsize=(10, 6))
sns.scatterplot(x='Temperature', y='Gas Level', hue='Day_Number', palette='tab10', data=data, legend=False)
...
plt.tight_layout()
plt.savefig('Temperature_vs_Gas_Level.png', dpi=300)
plt.show()

# Scatter plot for Humidity vs. Gas Level with regression line
plt.figure(figsize=(10, 6))
sns.scatterplot(x='Humidity', y='Gas Level', hue='Day_Number', palette='tab10', data=data, legend=False)
sns.regplot(x='Humidity', y='Gas Level', data=data, scatter=False, color='blue')
plt.title('Humidity vs. Gas Level')
plt.xlabel('Humidity')
plt.ylabel('Gas Level')
plt.tight_layout()
plt.savefig('Humidity_vs_Gas_Level.png', dpi=300)
plt.show()
